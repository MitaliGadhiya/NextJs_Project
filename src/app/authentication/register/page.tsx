...
import { RegisterSchema } from "@/validators/authentication.validator";
  ...
  return (
    <>
      ...
      >
        ...
        <HeaderLogin />
        <Box sx={{ width: "100%", position: "relative", height: "540px" }}>
          <Image
        ...
        >
          ...
          >
            ...
            <Box
              sx={{
                ...
                paddingRight: { xs: "100px", sm: "none", md: "68px" },
              }}
            >
              <Box
                sx={{
            ...
            <Box
              sx={{
                ...
                height: { xs: "395px", sm: "320px", md: "380px" },
                ...
                top: { xs: "21rem", sm: "28rem", md: "32rem" },
                boxShadow: "0px 4px 20px rgba(0, 0, 0, 0.2)",
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                  <CustomFormTextField
                    ...
                    style={{
                      background: mainTheme.palette.secondary.main,
                      clipPath:
                        "polygon(5% 0px, 95% 0px, 110% 50%, 95% 100%, 5% 100%, -25px 54%)",
                ...
                <Box mt={2}>
                  <CustomFormTextField
                    ...
                    id="description"
                    name="description"
                    label="| we love meeting new people. what inspires you to journey with us?"
                    type="text"
                    style={{
                      background: mainTheme.palette.secondary.main,
                      clipPath: isMobile
          ...
          <Box
            sx={{
              position: "absolute",
              top: { xs: "36rem", sm: "42rem", md: "44rem" },
              width: "100%",
              padding: "2rem",
              textAlign: "center",
            }}
